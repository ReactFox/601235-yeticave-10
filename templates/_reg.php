...
<form class="form container <?= $classname ?>" action="../register.php" method="post" enctype="multipart/form-data"
    ...
    <div class="form__item <?= $field_pass_error ?>">
        ...
        <input id="password" type="password" name="password" value="<?= getPostVal('password') ?>"
    ...
    <div class="form__item <?= $field_name_error ?>">
        ...
        <input id="name" type="text" name="user_name" value="<?= getPostVal('user_name') ?>" placeholder="Введите имя">
    ...
    <div class="form__item <?= $field_contacts_error ?>">
        ...
        <textarea id="message" name="contacts"
                  placeholder="Напишите как с вами связаться"><?= getPostVal('user_name') ?></textarea>
